      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-8">
          ...
          <div className="glass rounded-2xl p-6 shadow-lg border border-white/40 animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
            ...
            <div className="flex items-center space-x-2">
              <div className={`flex items-center space-x-1 px-2 py-1 rounded-full ${analyticsData.cards.revenue.growth >= 0 ? 'bg-green-100' : 'bg-red-100'
                }`}>
          ...
          <div className="glass rounded-2xl p-6 shadow-lg border border-white/40 animate-fadeInUp" style={{ animationDelay: '0.5s' }}>
            ...
            <div className="flex items-center space-x-2">
              <div className={`flex items-center space-x-1 px-2 py-1 rounded-full ${analyticsData.cards.bookings.growth >= 0 ? 'bg-green-100' : 'bg-red-100'
                }`}>
          ...
          <div className="glass rounded-2xl p-6 shadow-lg border border-white/40 animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
            ...
            <div className="flex items-center space-x-2">
              <div className={`flex items-center space-x-1 px-2 py-1 rounded-full ${analyticsData.cards.occupancy.growth >= 0 ? 'bg-green-100' : 'bg-red-100'
                }`}>
                ...
                return (
                  <div key={month.name} className="flex-1 flex flex-col items-center">
                    <div className="w-full flex-1 flex items-end justify-center mb-2 relative group">
                      ...
                      {/* Bar */}
                      <div
                        className={`w-full rounded-t-lg transition-all hover:opacity-80 cursor-pointer animate-slideUp ${month.revenue > 0
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            <div className="flex items-center bg-slate-100 rounded-xl p-1 overflow-x-auto max-w-full">
              <button
                ...
                className={`px-4 py-2 rounded-lg font-semibold text-sm transition-all ${selectedTab === 'hotels'
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-semibold text-sm transition-all ${selectedTab === 'rooms'
                    ? 'bg-white text-slate-900 shadow-sm'
                    : 'text-slate-600 hover:text-slate-900'
                  }`}
              >
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-semibold text-sm transition-all ${selectedTab === 'events'
                    ? 'bg-white text-slate-900 shadow-sm'
                    : 'text-slate-600 hover:text-slate-900'
                  }`}
              >
        ...
        <div className="glass rounded-2xl p-6 md:p-8 shadow-lg border border-white/40 animate-fadeInUp my-10" style={{ animationDelay: '0.9s' }}>
          <div className='flex justify-between items-center'>
            ...
            <Button variant='primary' className='px-4' onClick={viewAllBookings}>
              View All
            </Button>
          </div>
                  ...
                  {analyticsData.recent_bookings.map((booking) => (
                    <tr key={booking.id} className="border-b border-slate-100 hover:bg-slate-50 transition-colors">
                      ...
                      <td className="py-4 px-4 text-center">
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${booking.status === 'confirmed' ? 'bg-green-100 text-green-800' : 'bg-slate-100 text-slate-800'
                          }`}>
